...
public class Room {
	...
	public void move(char a) {
		if (food == true && water == true && lottery == true && lyft == true && check == true && app == true
				&& crosswalk == true && quarter == true && piano == true && snack == true && cockroach == true
				&& wendy == true && gate == true && flyer == true && course == true) {
			System.out.print("Congrats! You survived today's RUSCREW. GOod luck getting through 4 more years");
		...
		// 1
			...
			if (a == 'w' && lyft == false) { // Player moves up
				...
				System.out.println(
						"Do you want to run accross without clicking the pedestrian button that flashes the lights? (y/n)?");
				if (scn.nextLine().equals("y")) {
					crosswalk = true;
					points++;
				} else {
		...
		// 3
			...
			if (a == 'w' && cockroach == false) { // Player moves up
				System.out.println(
						"You do not want to go that way, as the dorms there have a cockroach " + "infestation");
